...
@bot.event
async def on_ready():
    print("Auto Bumper Is Online!" + " Username: " + bot.user) # https://discordpy.readthedocs.io/en/stable/ext/commands/api.html?highlight=run#discord.ext.commands.Bot.fetch_user
